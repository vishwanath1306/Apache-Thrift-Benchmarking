...
#include "gen-cpp/uniqueid_types.h"
...
int main(){
        ...
        auto trans = make_shared<TNonblockingServerSocket>(3067);

        auto handler_fac = make_shared<UniqueIDHandlerFactory>();
        auto processor_fac = make_shared<UniqueIDProcessorFactory>(handler_fac);
